...
Console.WriteLine("Podaj nazwę, potwierdź enterem i następnie podaj typ klimatyzacji: ");
string name = Convert.ToString(Console.ReadLine());
string type = Convert.ToString(Console.ReadLine());
director.ConstructAC(name, type);
...
Console.WriteLine("Podaj nazwę, potwierdź enterem i następnie podaj typ grzejnika: ");
name = Convert.ToString(Console.ReadLine());
type = Convert.ToString(Console.ReadLine());
directorH.ConstructHeater(name, type);
